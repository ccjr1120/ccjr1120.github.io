...
function HomePage() {
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background: theme === "dark" ? "#111827" : "#FEF5F6",
      ...
      >
        <button
          ...
          style={{
            ...
            boxShadow:
              theme === "dark"
                ? "0 4px 24px rgba(244,114,182,0.2)"
                : "0 4px 24px rgba(230,0,118,0.15)",
          }}
        ...
        >
          ...
          >
            <p
              style={{
                fontSize: "15px",
                color: theme === "dark" ? "#9CA3AF" : "#A57686",
                lineHeight: "normal",
                margin: 0,
              }}
            >
                  ...
                  >
                    ...
                    >
                      {i === 0 && (
                        <span
                          style={{
                            color: theme === "dark" ? "#F472B6" : "#CF5473",
                            fontSize: "12px",
                            flexShrink: 0,
                          }}
                        >
